    ...
    <div className="after-payment-popup">
      <div className="payment-popup">
        ...
        <div className="payment-popup-right">
          <p style={{ color: "#13B251", fontSize: "32px", fontWeight: "600" }}>
            Thank you for your order
          </p>
          <div className="orderid">
            <span>order#123456343</span>
            <span>date: 15.09.2024</span>
          </div>
          <hr />
          <div className="payment-popup-right-second-column">
            <div className="second-column-first">
              <p>1</p>
            </div>
            <p style={{ flex: "1", marginTop: "10px", marginLeft: "15px" }}>
              Margherita pizza
            </p>
          ...
          <div className="payment-popup-right-forth">
            <p className="forth-payment-total-lable third-payment-lable">
              Total Amount
            </p>
