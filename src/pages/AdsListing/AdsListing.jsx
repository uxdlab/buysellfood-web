...
import { CALORIES_COUNT_RANGE, COLOR, COOKING_TYPE, FOOD_FREE_FROM, FOOD_GROUP, FOOD_MADE, FOOD_MAKE, FOOD_VARIETY, SELER_TYPE, VERIFICATION_TYPE } from '../../utils/constants';
...
export const AdsListing = () => {
    ...
    async function searchData(s) {
        ...
        try {
            ...
            if (sort_by) {
                res.sort((a, b) => sort_by === "highToLow" ? (parseInt(b.price) - parseInt(a.price)) : (parseInt(a.price) - parseInt(b.price)))
            }
            setAllProducts(res)
        } catch (error) {
            console.log(error)
    ...
    return (
        <div className="adsListingMainCon pb-4">
            ...
            <div className="addListing_gridcon">
                <div>
                    <div>Filter By <FilterAltIcon /></div>
                    ...
                    <div>
                        <form onSubmit={handleSubmit(searchData)} className="main-select-box">
                            ...
                            <button onClick={resetForm} className="btn border mt-3 w-100">Remove Filter</button>
                        </form>
                    </div>
